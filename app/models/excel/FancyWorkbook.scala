...
class FancyWorkbook(protected[models] val workbook: Workbook) {

  override def toString = "Workbook"

  protected[models] val defaultFont = new FancyFont

  protected[models] val defaultStyle = {
    val style = new FancyCellStyle
    style.setFont(defaultFont)
    style
  }

  protected[models] val tmpFont = new FancyFont

  protected[models] val tmpStyle = new FancyCellStyle
